...
const NuevoPassword = () => {
  ...
  return (
    <>
        <div>
          <h1 className="text-indigo-600 font-black text-6xl">Restablece tu password y no Pierdas Acceso a {''}<span className="text-black">tus compras</span></h1>
        </div>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        {
          ...
          {
            passwordModificado && 
            <Link className='block text-center my-5 text-gray-500' to="/auth">Iniciar Sesion</Link>
          }
        </div>
    </>
  )
