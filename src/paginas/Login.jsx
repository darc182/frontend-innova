...
const Login = () => {
  ...
  return (
    <>
        ...
        <div>
          <h1 className="text-indigo-600 font-black text-6xl">Inicia Sesion y Empieza {''}<span className="text-black">a Comprar</span></h1>
        </div>
...

        {
          ...
          <nav className='mt-10 lg:flex lg:justify-between'>
            ...
            <Link className='block text-center my-5 text-gray-500' to='/auth/olvide-password'>Olvide mi Password</Link>
          </nav>
        </div>
    </>
  )
